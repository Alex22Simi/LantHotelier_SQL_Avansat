...
INSERT INTO P_Hotel (id_hotel, nume, judet, oras, nr_etaje, camere_pe_etaj, nr_angajati)
VALUES (1, 'Hotel Central Calimanesti', 'Valcea', 'Calimanesti', 5, 20, 89);
INSERT INTO P_Hotel (id_hotel, nume, judet, oras, nr_etaje, camere_pe_etaj, nr_angajati)
VALUES (2, 'Hotel Cozia', 'Valcea', 'Calimanesti', 6, 25, 193);
INSERT INTO P_Hotel (id_hotel, nume, judet, oras, nr_etaje, camere_pe_etaj, nr_angajati)
VALUES (3, 'Hotel Caciulata', 'Valcea', 'Calimanesti', 4, 22, 143);
INSERT INTO P_Hotel (id_hotel, nume, judet, oras, nr_etaje, camere_pe_etaj, nr_angajati)
VALUES (4, 'Hotel Oltul', 'Valcea', 'Calimanesti', 8, 30, 155);
...
select * from P_Tipuri_Angajati;
select * from P_Departament;
select * from P_Hotel;
select * from p_Camera;
select * from p_Obiecte_inventar;
select * from P_Client;
select * from P_Angajat;
select * from P_Rezervari;
select * from P_Recenzii;
select * from P_Servicii;
select * from P_Servicii_Rezervari;
select * from P_Plati;
select * from P_Materiale;
select * from P_Consum_Materiale;
